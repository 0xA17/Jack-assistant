...
namespace Jack
{
    public class AnswerDictionary
    {
        ...
        public static String[] CommandNotFound = { "Комманда не распознона", "Хмм, такой команды нету", "Ты уверен в своей команде?", "Упс, команда не найдена", "Повтори ка, такой команды нету"};
    }
}
