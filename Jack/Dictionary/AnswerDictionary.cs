...
namespace Jack
{
    public class AnswerDictionary
    {
        ...
        public static String[] VolumeIsBadAnswer = {"выбери от нуля до ста", "это некорректное значение для громкости", "такое значение не подходит", "плохое значение для громкости"};
